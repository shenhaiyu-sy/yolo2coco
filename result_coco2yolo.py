...
def parse_opt():
    ...
    parser.add_argument('--label_coco', type=str, default=r'D:\scholar\pycharm_project\CV\Detection\mmdetection\data\SAR-3k-coco\annotations\instances_test2017.json',
                        help='label coco path')
    #parser.add_argument('--pred_coco', type=str, default='work_dirs/faster-rcnn_r50_fpn_1x_coco/20241017_093545/20241017_093545.json', help='pred coco path')
    parser.add_argument('--pred_coco', type=str, default='res.pkl', help='pred coco path')
